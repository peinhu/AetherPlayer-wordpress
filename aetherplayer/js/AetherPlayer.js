...
(function() {
	...
	var config = {
		dataStorage : 'database',//[file|database] The way to storage playlist. If you choose database, then you should declare and assign a JavaScript variable named aetherplayer_playList_database in script tag.
